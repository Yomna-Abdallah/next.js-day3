...
<section  className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-gray-700">
    <div className="flex py-8 px-4 mx-auto items-center justify-center">
